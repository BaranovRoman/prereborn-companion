...
// apps/web/src/components/pages/stream/queue/queue-scene-config.ts (pure
// TS, zero framework deps) - same DPR caps/quality tiers as the web
// reference, not a Companion-specific reinterpretation (see
// red-fog-background.tsx for how `DEFAULT_QUEUE_QUALITY` is applied here).
